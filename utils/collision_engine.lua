...
function colission_entity:new(x, y, width, hight)
...
function do_collide(obj1, obj2)
    ...
    if obj1.x < obj2.x + obj2.width and
       ...
       obj1.y < obj2.y + obj2.hight and
       obj1.y + obj1.hight > obj2.y then
...
function colission_entity:draw()
    ...
    pset(self.x, self.y + self.hight - 1, 8)  -- bottom-left corner
    pset(self.x + self.width - 1, self.y + self.hight - 1, 8)  -- bottom-right corner
end